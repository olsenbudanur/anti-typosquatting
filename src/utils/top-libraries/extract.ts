...
async function downloadLatestTop() {
    const curlCommand = 'curl -LJO https://github.com/LeoDog896/npm-rank/releases/download/latest/raw.json';
...
async function extractLibraryNames(
        ...
        outputFilePath: string = "src/utils/top-libraries/top10000libs.txt"
    ): Promise<void> {
